...
import 'package:traveler/pages/sub/profile_page.dart';
...
class _FirstMainPageState extends State<FirstMainPage> {
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  button(
                    width: width / 1.9,
                    backgroundColor: Color(0xffB8FF5E),
                    splashColor: Color(0xffAFF872),
                    textColor: Colors.white,
  ...
  void profilePage() {
    this.widget.mainPage.changeBody(ProfilePage(this.widget.mainPage));
  }
  ...
  void settings() {
    this.widget.mainPage.changeBody(SettingsPage(this.widget.mainPage));
  }
}
